...
const mockArticles = [
  ...
  },
  {
    ...
    excerpt:
      "La Gobernación del Meta ha dado inicio a las obras del nuevo puente que conectará varias veredas, mejorando el transporte de productos agrícolas.",
  ...
  },
  {
    ...
    excerpt:
      "Mapiripán se prepara para su tradicional festival. Este año contará con la participación de artistas de talla nacional e internacional.",
    category: "Cultura",
    date: "2025-09-12",
  ...
  },
  {
    ...
    excerpt:
      "A pesar de las condiciones climáticas, los agricultores de la región reportan una de las mejores cosechas de yuca de los últimos cinco años.",
  ...
  },
  {
    ...
    excerpt:
      'El equipo de fútbol juvenil "Centauros del Llano" obtuvo el segundo lugar en la copa departamental, un logro histórico para el municipio.',
    category: "Deporte",
    date: "2025-09-08",
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 cursor-pointer group h-full flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-grow">
        <span className="text-sm bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full font-semibold self-start">
          {article.category}
        </span>
        <h3 className="font-bold text-xl mt-3 mb-2 text-gray-800 flex-grow">
          {article.title}
        </h3>
  ...
  return (
    <section id="noticias" className="container mx-auto py-16 px-6 font-sans">
      <div className="w-full flex mb-2 items-center">
        ...
        <h1 className="ml-3 text-4xl font-bold text-green-900">
          Últimas Noticias
        </h1>
      </div>
      ...
      {error && (
        <div className="text-center p-10 text-red-700 bg-red-100 rounded-lg">
          {error}
        </div>
      )}
